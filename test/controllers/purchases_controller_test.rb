...
class PurchasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create purchase" do
    assert_difference('Purchase.count') do
      post purchases_url, params: { purchase: { game_id: @purchase.game_id, user_id: @purchase.user_id } }
    end
  ...
  test "should update purchase" do
    patch purchase_url(@purchase), params: { purchase: { game_id: @purchase.game_id, user_id: @purchase.user_id } }
